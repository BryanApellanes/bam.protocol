...
namespace Bam.Protocol.Data.Client.Dao.Repository
{
	...
	public partial class ClientSessionSchemaRepository: DaoRepository
	{
		...
		{
			SchemaName = "ClientSessionSchema";
			...
			AddType<Bam.Protocol.Data.Client.ClientSessionData>();
			
			
			AddType<Bam.Protocol.Data.Client.ClientSessionKeyValue>();
			

			DaoAssembly = typeof(ClientSessionSchemaRepository).Assembly;
		}
		...
		/// of the specified columns.
		/// </summary>
		public void SetOneClientSessionDataWhere(WhereDelegate<ClientSessionDataColumns> where)
		{
			Bam.Protocol.Data.Client.Dao.ClientSessionData.SetOneWhere(where, Database);
		}
		...
		/// Execute a query that should return only one result.  If no result is found null is returned.  If more
		/// than one result is returned a MultipleEntriesFoundException is thrown.  This method is most commonly used to retrieve a
		/// single ClientSessionData instance by its Id/Key value
		/// </summary>
		/// <param name="where">A WhereDelegate that receives a ClientSessionDataColumns 
		/// and returns a IQueryFilter which is the result of any comparisons
		/// between ClientSessionDataColumns and other values
		/// </param>
		...
		/// Execute a query and return the results. 
		/// </summary>
		/// <param name="where">A WhereDelegate that receives a Bam.Protocol.Data.Client.ClientSessionDataColumns 
		/// and returns a IQueryFilter which is the result of any comparisons
		...
		/// between ClientSessionDataColumns and other values
		/// </param>
		public IEnumerable<Bam.Protocol.Data.Client.ClientSessionData> TopClientSessionDatasWhere(int count, WhereDelegate<ClientSessionDataColumns> where)
        {
            return Wrap<Bam.Protocol.Data.Client.ClientSessionData>(Bam.Protocol.Data.Client.Dao.ClientSessionData.Top(count, where, Database));
        }

        public IEnumerable<Bam.Protocol.Data.Client.ClientSessionData> TopClientSessionDatasWhere(int count, WhereDelegate<ClientSessionDataColumns> where, OrderBy<ClientSessionDataColumns> orderBy)
        {
            return Wrap<Bam.Protocol.Data.Client.ClientSessionData>(Bam.Protocol.Data.Client.Dao.ClientSessionData.Top(count, where, orderBy, Database));
        }
                                
		/// <summary>
		/// Return the count of ClientSessionDatas
		/// </summary>
		public long CountClientSessionDatas()
        {
            return Bam.Protocol.Data.Client.Dao.ClientSessionData.Count(Database);
        }
		...
		/// between ClientSessionDataColumns and other values
		/// </param>
        public long CountClientSessionDatasWhere(WhereDelegate<ClientSessionDataColumns> where)
        {
            return Bam.Protocol.Data.Client.Dao.ClientSessionData.Count(where, Database);
        }
        
        /*public async Task BatchQueryClientSessionDatas(int batchSize, WhereDelegate<ClientSessionDataColumns> where, Action<IEnumerable<Bam.Protocol.Data.Client.ClientSessionData>> batchProcessor)
        {
            await Bam.Protocol.Data.Client.Dao.ClientSessionData.BatchQuery(batchSize, where, (batch) =>
            {
				batchProcessor(Wrap<Bam.Protocol.Data.Client.ClientSessionData>(batch));
            }, Database);
        }*/
		
        public async Task BatchAllClientSessionDatas(int batchSize, Action<IEnumerable<Bam.Protocol.Data.Client.ClientSessionData>> batchProcessor)
        {
            await Bam.Protocol.Data.Client.Dao.ClientSessionData.BatchAll(batchSize, (batch) =>
            {
				batchProcessor(Wrap<Bam.Protocol.Data.Client.ClientSessionData>(batch));
            }, Database);
        }
