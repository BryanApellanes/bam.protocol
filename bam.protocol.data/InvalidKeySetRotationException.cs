...
/// (rotation is not registration — use <see cref="IPublicKeySetRegistrar.Register"/>), or the
/// presented rotation signature does not prove possession of the currently registered key.
/// The registered key set is left unchanged in every rejection case.
/// </summary>
