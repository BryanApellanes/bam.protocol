...
namespace Bam.Protocol.Data.Common.Wrappers
{
	// generated
	[Serializable]
	public class MachineDataWrapper: Bam.Protocol.Data.Common.MachineData, IHasUpdatedXrefCollectionProperties
	{
		public MachineDataWrapper()
		{
			this.UpdatedXrefCollectionProperties = new Dictionary<string, PropertyInfo>();
		}

		public MachineDataWrapper(DaoRepository repository) : this()
		{
		...
		public override System.Collections.Generic.List<Bam.Protocol.Data.Common.HostAddressData> HostAddresses
		{
			get
			{
				...
				{
					_hostAddresses = DaoRepository.ForeignKeyCollectionLoader<Bam.Protocol.Data.Common.MachineData, Bam.Protocol.Data.Common.HostAddressData>(this).ToList();
				}
		...
		public override System.Collections.Generic.List<Bam.Protocol.Data.Common.NicData> NetworkInterfaces
		{
			get
			{
				...
				{
					_networkInterfaces = DaoRepository.ForeignKeyCollectionLoader<Bam.Protocol.Data.Common.MachineData, Bam.Protocol.Data.Common.NicData>(this).ToList();
				}
